...
url = 'https://www.tripadvisor.in/Hotels-g294201-oa30-Cairo_Cairo_Governorate-Hotels.html#BODYCON'
...
cairo.to_csv('hotels.csv', mode = 'a',index=False, header=False)
#review.to_csv('hotelReview.csv',mode='a', index=False, header=True)
